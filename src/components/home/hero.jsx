     ...
     const profiledata = [
          {
               ...
               style:"",
               textstyle:"sm:items-end sm:pl-32",
               headingstyle:"sm:text-end",
          },
          {
    ...
    <div className='relative'>
     ...
     <div className='relative min-h-screen sm:flex'>
          ...
          <div className=' relative'>
               ...
               <img src="https://www.pracharexpert.com/assets/images/image/logo-1.png" className='googleimage sm:top-16 h-32 absolute' />
               <img src="https://www.pracharexpert.com/assets/images/image/Group%203%20(2).png" className=' sm:top-[82vh] graphimage h-32 absolute' />
          </div>
     </div>
     <div className=' relative herocompenys sm:flex mt-10 items-center'>
          <p className=' font-bold text-xl ml-9'>Trusted by Top Companies</p>
          <div className='overflow-x-auto w-full'>
               <div className='flex herocmpnylogo w-full justify-between'>
     ...
     <div data-aos="fade-in" className='relative sm:flex items-center px-10 sm:mt-20 gap-5 justify-around'>
          <div className=' sm:w-1/2 max-h-[80vh]'>
     ...
     <div className='relative serviceinhero sm:mt-32'>
          <h1 className=' sm:text-4xl sm:mb-20 w-full text-center font-semibold'>Service We O<span className='underline underline-offset-4'>ffe</span>r</h1>

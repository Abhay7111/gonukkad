...
function Navunder() {
  return (
    <div className='w-80 p-5 h-fit flex items-center flex-col bg-[#5e4fbe] rounded-xl mt-2'>
          <ul className='flex flex-col items-center w-full font-medium tracking-wide text-zinc-100'>

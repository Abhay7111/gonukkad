     ...
     <div className='w-full flex flex-col items-center veribody bggradiyant'>
      <Img/>
        ...
        <div className='sm:flex w-[95%] sm:h-60 sm:mt-10 rounded-xl'>
          <div className='sm:w-[70%] h-full flex items-center justify-center flex-col'>
              <div className=' sm:w-[70%] verybtnwdth rounded-2xl h-2 flex items-center justify-between bg-[#AA9FEF]'>
                <div className='sm:w-14 sm:h-14 veribtn btn_1 hover:bg-[#195180] relative z-30 cursor-pointer text-xl font-medium bg-white transition-all flex items-center justify-center rounded-full hover:shadow-xl'> <span className='hover:text-zinc-100 w-full h-full flex items-center justify-center rounded-full span1'>1</span> <span className='absolute sm:text-[0.9rem] verybtntext leading-none top-[115%] hover:text-zinc-700'>Discussin</span></div>

...
function About() {
  return (
    <div>
     ...
     <div className='sm:flex gap-5 aboutcard justify-center relative bg-white py-20'>
      <div className='sm:w-1/4 flex aboutcardtop items-center flex-col '>
      ...
      <div className='sm:w-1/4 flex aboutcardbottom items-center flex-col '>
     ...
     <div className=' flex items-center flex-col relative bg-[#e6f4ff] pt-16 pb-20'>
        <h1 className='text-4xl text-center font-semibold mb-4'>Why should you choose Gonukkad?</h1>
        ...
        <div className='w-[70vw] rounded-3xl sm:h-72 bg-violet-200 py-8 px-4 mt-10 sm:flex items-start justify-center'>
          <div className='sm:w-1/3 aboutchoosingcard px-2 py-3'>
          ...
          <div className='sm:w-1/3 aboutchoosingcard aboutchoosingcard2 px-2 border-l border-zinc-600 py-2'>
            <div className='flex items-center gap-3 font-medium'>
          ...
          <div className='sm:w-1/3 aboutchoosingcard aboutchoosingcard3 px-2 border-l border-zinc-600 py-2'>
            <div className='flex items-center gap-3 font-medium'>
     ...
     <div className='sm:flex relative bg-white aboutjurneyparent sm:py-20'>
      <Img/>
        <div className='sm:w-1/2 min-h-20 sm:flex items-center justify-center'>
        ...
        <div className='sm:w-1/2 min-h-20 font-medium'>
          <h1 className='text-4xl aboutjurneyheading sm:mb-10'>Our Journey</h1>
          <p className=' sm:pr-20 py-2'>In 2019, we began our journey on Amazon and learned from our mistakes, including dealing with accounts and listing suspensions and shipping issues. After many ups and downs, we emerged victorious.
            <br />
            <br />
      ...
      <Img/> 
        ...
        <div className='sm:flex flex-wrap text-zinc-300 px-7 gap-8 mt-10 justify-around'>
          ...
          <div className='sm:w-[43%] p-5 min-h-20 rounded-xl'>
            ...
            <p className='mt-3 leading-5 sm:pr-12'>Stay ahead of the competition with our in-depth competitive analysis. We analyze market trends, competitor strategies, and customer preferences to provide you with valuable insights that can inform your business decisions and help you outperform your competitors.</p>
          </div>
          <div className='sm:w-[43%] p-5 min-h-20 rounded-xl'>
            <div className='flex gap-3 font-medium'>
